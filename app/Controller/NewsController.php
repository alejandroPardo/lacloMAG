...
class NewsController extends AppController {
    ...
    public function createNews() {
        if ($this->request->is('post')) {
            $this->News->create();
            $data = array('headline' => $this->data['title'], 'summary' => $this->data['summary'], 'content' => $this->data['content'], 'video_url' => $this->data['video'], 'status' => 'NEWS', 'author' => $this->Auth->user('id') );
